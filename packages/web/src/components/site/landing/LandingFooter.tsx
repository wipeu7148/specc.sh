  ...
  return (
    <footer className="relative py-12 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {[
                ...
                { label: t("landing.nav.howItWorks"), href: "#howItWorks" },
                { label: t("landing.nav.techStack"), href: "#techStack" },
              ].map((l) => (
                <li key={l.href}>
                  <a
                    href={l.href}
        ...
        {/* Bottom */}
        <div className="mt-10 pt-6 border-t border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500 dark:text-zinc-500">
